...
namespace RGB.NET.Core
{
    ...
    public static class IdGenerator
    {
        ...
        private static readonly Dictionary<Assembly, Dictionary<string, string>> _idMappings = new Dictionary<Assembly, Dictionary<string, string>>();
        private static readonly Dictionary<Assembly, Dictionary<string, int>> _counter = new Dictionary<Assembly, Dictionary<string, int>>();
