...
namespace RGB.NET.Core
{
    ...
    public static class TimerHelper
    {
        ...
        private static readonly HashSet<HighResolutionTimerDisposable> _timerLeases = new HashSet<HighResolutionTimerDisposable>();
        ...
        {
            List<HighResolutionTimerDisposable> timerLeases = new List<HighResolutionTimerDisposable>(_timerLeases);
