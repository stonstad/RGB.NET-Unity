...
namespace RGB.NET.Core
{
    ...
    public abstract class AbstractRGBDeviceProvider : IRGBDeviceProvider
    {
        ...
        /// </summary>
        protected List<IRGBDevice> InternalDevices { get; } = new List<IRGBDevice>();
        ...
        /// </summary>
        protected Dictionary<int, IDeviceUpdateTrigger> UpdateTriggerMapping { get; } = new Dictionary<int, IDeviceUpdateTrigger>();
        ...
        protected virtual void Reset()
        {
            ...
            List<IRGBDevice> devices = InternalDevices.ToList();
            foreach (IRGBDevice device in devices)
                RemoveDevice(device);
