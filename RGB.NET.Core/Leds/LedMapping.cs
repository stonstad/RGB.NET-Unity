...
namespace RGB.NET.Core
{
        ...
        where T : notnull
    {
        ...
        public static LedMapping<T> Empty { get; } = new LedMapping<T>();

        #endregion

        #region Properties & Fields

        private readonly Dictionary<LedId, T> _mapping = new Dictionary<LedId, T>();
        private readonly Dictionary<T, LedId> _reverseMapping = new Dictionary<T, LedId>();
